...
def main():
    ...
    print(test_algorithm((random_next_action,     monte_carlo_tree_search_next_action)))
    print(test_algorithm((nega_alpha_next_action, monte_carlo_tree_search_next_action)))

    # state = State()

    # for next_action in cat(repeat((monte_carlo_tree_search_next_action, random_next_action))):  # random_next_action, nega_max_next_action, nega_alpha_next_actionの中から適当に選んでください
    #     if state.end:
    #         break;
